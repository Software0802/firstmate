...
`bin/fm-composer-lib.sh` is the fleet-wide owner that strips dim or faint runs and dark placeholders in either foreground spelling a terminal makes a harness use, truecolor or 256-colour, while retaining bright typed input.
