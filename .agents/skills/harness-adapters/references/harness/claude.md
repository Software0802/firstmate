...
`../../../docs/herdr-backend.md` under "Composer and injection safety" owns dark-foreground tradeoffs and `../../../docs/verification/runtime-backends.md` owns captures.
