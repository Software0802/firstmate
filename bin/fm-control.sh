...
#              submits the harness's exit command. Postcondition: the backend's
#              recovery-grade classifier reports the agent gone.
...
do_exit() {
  local state cmd verdict composer_state cancel absence record interrupt_result=not-needed
